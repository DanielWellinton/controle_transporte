                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('veiculos.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="descricao" class="block mt-1 w-full" type="text" name="descricao" :value="old('descricao')" required placeholder="Ex: Ônibus Executivo - Volare V8" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="placa" class="block mt-1 w-full uppercase" type="text" name="placa" :value="old('placa')" required placeholder="ABC1D23" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="numero_passageiros" class="block mt-1 w-full" type="number" name="numero_passageiros" :value="old('numero_passageiros')" required min="1" />
