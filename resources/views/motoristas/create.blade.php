                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('motoristas.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="cnh" class="block mt-1 w-full" type="text" name="cnh" :value="old('cnh')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="data_validade_cnh" class="block mt-1 w-full" type="date" name="data_validade_cnh" :value="old('data_validade_cnh')" required />
