...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-slate-500">Selecione uma rota para definir seus pontos de embarque e desembarque.</p>
        </div>
    </div>
    ...
    @if($viagens->isEmpty())
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-12 text-center">
            ...
            <h3 class="text-sm font-bold text-slate-800">Nenhuma viagem ativa</h3>
            <p class="text-xs text-slate-500 mt-1">Não há viagens agendadas ou em andamento no momento.</p>
        </div>
    @else
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-2.5 border-t border-slate-100 pt-4 text-xs text-slate-600">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span>Veículo: <strong class="text-slate-800">{{ $viagem->veiculo->modelo ?? 'N/A' }} ({{ $viagem->veiculo->placa ?? '-' }})</strong></span>
                            </div>
                        </div>
                    </div>
